...
sars = [
    ...
    SAR(
        ...
        gold_narrative =  {
                 {
        "54321098": "Sky Corporation had 284 cash deposits totaling $2,710,000 at Bank of Mainland, conducted through three main branches: North Burlington, South Burlington, and West Burlington. The average deposit amount ranged from $8,720 to $16,500. The day after deposits, 274 outgoing wire transfers totaling $2,697,000 were conducted, typically sent to Paul Lafonte at Artsy Bank, account #456781234 in Paris, France, using a remote computer terminal.The activity occured for the period  2/2/99 through 6/20/01",

        "12345678": "Sea Corporation had 200 cash deposits totaling $1,900,000 at Bank of Mainland, with many transactions conducted on the same day at multiple branches to potentially circumvent federal reporting requirements. The company processed 198 outgoing wire transfers totaling $1,866,000, usually mirroring the deposits from the previous day, and also directed to Paul Lafonte at Artsy Bank, account #456781234 in Paris, France.The activity occured for the period  2/2/99 through 6/20/01",

        "689472": "Tolinka Inc. is a customer of Bank XYZ and received 15 incoming wire transfers affecting account #12345678 at Bank of Mainland. Bank XYZ was unable to provide documentation for Tolinka Inc., and after inquiries, Tolinka Inc. closed its account without explanation.The activity occured for the period  2/2/99 through 6/20/01"
    }}
    )
